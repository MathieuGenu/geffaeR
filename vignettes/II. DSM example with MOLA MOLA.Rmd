...
## What ?
Mola Mola known as Sunfish is a marine species that can reach 1ton ! It can live in temperate and tropical waters. It have a particular shape that makes it easy to recognize :

```{r molamola image, echo = F, out.width='250px'}
knitr::include_graphics(paste0(here::here(),"/man/Figures/Mola_mola.jpg"))
```

## How ?
The data were collected during the SAMM capaign. This campaign consist in flying over the sea and count all observation of marine mammals and Seabirds mainly. Part of the campaign occured in the Mediterranean sea.
...
knitr::include_graphics(file.path(here::here(),"man/Figures/DSM_functions.png"))
```
