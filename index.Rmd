...
When a lot of distance sampling campaign are made, analysis have to be done to estimate abundance with tools such as distance, dsm, kriging. But from a campaign to another, the objectives are not always the same, while the method remains the same. So geffaeR aims at simplify the process of analyzing observation campaign and avoid to have to rewrite functions and script to adapt for each study case.
